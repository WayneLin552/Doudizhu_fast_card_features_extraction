...
def brother(up,down): #down是下家的role #下家农民队友283 上家农民队友284 1为农民，0为地主
    list1 = []
    list2 = []
    list1.append(abs(up-down)*up) #0非农民队友，1为农民队友
...
def sortgenpai1(x): #跟牌特征330-343
    ...
    return list1
# import time
def combine_all(n,b,a,up,down,lastplay):   #参数分别是当前手牌，上家手牌，下家手牌，上家角色，下家角色，上次出牌
