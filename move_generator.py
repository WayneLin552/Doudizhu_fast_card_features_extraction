...
class MovesGener(object):
    ...
    def __init__(self, cards_list):
        ...
        for i in self.cards_list:
            self.cards_dict[i] += 1    # 返回一个字典，字典形式为   {牌：几张}   类型
    #创建一系列空集
    ...
    def _gen_serial_moves(self, cards, min_serial, repeat=1, repeat_num=0):
        ...
        for seq in seq_records:
            ...
            longest_list = single_cards[start: start + longest]    #找到牌组中最长的顺子牌并定义为longest_list

            if repeat_num == 0:  # 不限制有多少个顺子
                steps = min_serial
                while steps <= longest:
                    index = 0
...
cd1=[3, 4, 4, 5, 6, 6, 7, 7, 8, 9, 10, 11, 11, 12, 13, 13, 13, 14, 17, 17]
cd2=[3, 4, 4, 5, 6, 6, 7, 7, 8, 9, 10, 11, 11, 12, 13, 20, 30]
cd3=[3, 3, 5, 5, 8, 8, 9, 9,10, 10, 12, 12,14, 14, 14,17,17]

mg1 = MovesGener(cd1)
mg2 = MovesGener(cd2)
mg3 = MovesGener(cd3)
player1 = mg1.gen_type_1_single()
player2 = mg2.gen_type_1_single()
player3 = mg3.gen_type_1_single()
print(player1[-1][0])

print(player1)
print(player2)
print(player3)
#playere2 = gen_type_1_single(cd2)
